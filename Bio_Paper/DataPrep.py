...
train_datasets, test_datasets,benchmark, cumulative_benchmark = prep_incremental_benchmark(train_loc='../DATA/TRAIN_DATA.csv', test_loc='../DATA/TEST_DATA.csv')

# for each dataset in cumulative_benchmark, print the available classes


# in the cumulative dataset, use the test_datasets to build the following incremental dataset:
    # 1st datast from 0 to 4
    # 2nd dataset from 0 to 9
    # 3rd dataset from 0 to 14
    # 4th dataset from 0 to 19
    # 5th dataset from 0 to 24
    # 6th dataset from 0 to 29
